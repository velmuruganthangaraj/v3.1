var QueryInputDialog = (function () {
    ...
    QueryInputDialog.prototype.renderParameterFields = function (target, id, itemType, headerText) {
        ...
        var lblHdrText = ej.buildTag('Label.e-designer-title-label', headerText, {}, {
            'type': 'label',
            'id': id + '_labelText'
        });
    ...
    QueryInputDialog.prototype.getCaptionLabel = function (caption, id) {
        ...
        var label = ej.buildTag('label.e-designer-title-label', caption, { 'max-width': '200px' }, {
            'id': id + '_labelText'
        });
    ...
    QueryInputDialog.prototype.getRowCaption = function (caption, id) {
        ...
        var infoLabel = ej.buildTag('label', this.getLocale('jsontext'), { 'font-size': '11px', 'float': 'right', 'padding-bottom': '3px' }, {
    ...
    QueryInputDialog.prototype.getTooltipTemplate = function () {
        var toolTipContent = '<div>' +
            '<div style = \'font-size: 12px; font-weight: 600; display: inline-block\'>String Parameter: </br></div>' +
            '<div style = \'font-size: 11px; display: inline-block\'>"ParameterValue"</div>' +
            '</div>' +
            '<div>' +
            '<div style = \'font-size: 12px; font-weight: 600; display: inline-block\'>Numeric Parameter: </br></div>' +
            '<div style = \'font-size: 11px; display: inline-block\'>485</div>' +
            '</div>' +
            '<div>' +
            '<div style = \'font-size: 12px; font-weight: 600\'>Json Parameter:</div>' +
            '<div style = \'font-size: 11px;\'>{ "Items": { "Quantity": "10 Units", "Price": "20 Rs" }, "Characteristics": { "color": "blue", "weight": "2 lb" } }</div>' +
            '</div>' +
            '<div>' +
            '<div style = \'font-size: 12px; font-weight: 600\'>Object Parameter:</div>' +
